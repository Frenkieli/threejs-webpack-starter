...
// const pointLightHelp2 = new THREE.PointLightHelper(pointLight3, 1);

// scene.add(pointLightHelp2);
...
function onDocumentMouseMove (even) {
    mouseX = (even.clientX - windowHalfX);
    mouseY = (even.clientY - windowHalfY);
}

document.addEventListener('mousemove', onDocumentMouseMove);

const updateSphere = (evevt) => {
